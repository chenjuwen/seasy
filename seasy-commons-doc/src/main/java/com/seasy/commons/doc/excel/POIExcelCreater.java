package com.seasy.commons.doc.excel;
...
import com.seasy.commons.doc.ColumnMetaData;
...
public class POIExcelCreater extends AbstractExcelCreater {
	...
	public POIExcelCreater(String title, List<ColumnMetaData> columnList, List<Map<String, String>> dataList, OutputStream out){
		this.title = title;
	...
	protected void generateHeader(){
		...
		for(int col=0; col<columnList.size(); col++){
			ColumnMetaData md = columnList.get(col);
